...
async def join_channel(event):
    try:
        await sython1(JoinChannelRequest("@eikeekl"))
...
async def join_channel(event):
    try:
        await sython2(JoinChannelRequest("@eikeekl"))
    except BaseException:
        pass
...
async def join_channel(event):
    try:
        await sython3(JoinChannelRequest("@eikeekl"))
    except BaseException:
        pass
...
async def join_channel(event):
    try:
        await sython4(JoinChannelRequest("@eikeekl"))
    except BaseException:
        pass
...
async def join_channel(event):
    try:
        await sython5(JoinChannelRequest("@eikeekl"))
    except BaseException:
        pass
...
@sython2.on(events.NewMessage(outgoing=False, pattern='/jn (.*)'))
async def OwnerStart(event):
    usercht = event.pattern_match.group(1)
    sender = await event.get_sender()
    if sender.id == ownerhson_id:
